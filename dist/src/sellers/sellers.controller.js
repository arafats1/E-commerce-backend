...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get list of all sellers' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update specific seller detail' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Successful',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete seller' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Successful',
    }),
