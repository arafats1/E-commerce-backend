...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get Items under a specific category id' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Successful',
    }),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CategoriesController.prototype, "findItems", null);
__decorate([
    (0, common_1.Patch)(':name'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a field in the category table' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Deletes a category' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Successful',
    }),
...
__decorate([
    (0, common_1.Put)(':name'),
    (0, swagger_1.ApiOperation)({ summary: 'Updates a category' }),
    (0, swagger_1.ApiParam)({
        name: 'id',
        type: 'number',
        description: 'Should be an id of a category that exists in the database',
